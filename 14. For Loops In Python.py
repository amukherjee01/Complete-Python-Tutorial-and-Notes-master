...
list1 = [["Vivek", 1], ["Larry", 2], ["Carry", 6], ["Marie", 250]]
for item in list1:
    print(item)
# Output :
# ['Vivek', 1]
...
for key, value in list1:
    print(f"{key} eats {value} choclate")
# output :
# Vivek eats 1 choclate
# Larry eats 2 choclate
# Carry eats 6 choclate
# Marie eats 250 choclate
